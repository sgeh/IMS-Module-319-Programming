...
namespace Bwz.Rappi
{
    public partial class FrmTicTacToe_v4 : Form
    {
        ...
        {
            Color playerColor;
            if (TryGetPlayerColor(_currentPlayer, out playerColor))
            {
                return playerColor;
            }
            return Color.Red;
        ...
        {
            if (TryLockPosition(toClick, _currentPlayer))
            {
                CheckWinPosition();
                SwitchPlayer();
            }
        ...
        {
            return (first.Text == _currentPlayer
                && second.Text == _currentPlayer
                && third.Text == _currentPlayer);
        }
